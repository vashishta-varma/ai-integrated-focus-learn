  ...
  return (
    <section className="min-h-[90vh] bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
      <div className="py-10 mx-auto max-w-screen-xl">
        <p className="text-gray-900 dark:text-white font-bold text-4xl">Explore Community</p>
        <p className="my-4 text-gray-700 dark:text-gray-300 text-md">Explore a vibrant community of learners and creators! Discover shared journeys, and access valuable resources and notes. Contribute your own ideas, and take your learning to the next level.</p>
      </div>
                ...
                <tbody>
                  {journeys.map(journey => (
                    <tr key={journey.id} className="border-b dark:border-gray-700">
                      <th scope="row" className="px-4 py-3 font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 whitespace-nowrap cursor-pointer">
                        {journey.title}
                      </th>
                      <td className="px-4 py-3 text-gray-700 dark:text-gray-300">{journey.username}</td>
                      ...
                      <td className="px-4 py-3 flex items-center justify-end">
                        { user.username === journey.username ? 
                         <Link to={'/'}
                         className="text-sm p-1 w-20 text-white bg-primary-600 dark:bg-gray-900 rounded-md flex justify-center items-center hover:bg-primary-700 dark:hover:bg-slate-600 gap-[2px] ">
                             <span>Your's 🌟</span>
                        ...
                        className="text-sm p-2 text-white bg-primary-600 dark:bg-gray-900 rounded-md flex justify-center items-center hover:bg-primary-700 dark:hover:bg-slate-600 gap-[2px] ">
                            <span>Fork</span>
